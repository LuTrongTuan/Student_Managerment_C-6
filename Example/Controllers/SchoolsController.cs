...
namespace Example.Controllers
{
    public class SchoolsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SchoolId,Name,Status")] School school)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SchoolId,Name,Status")] School school)
        {
